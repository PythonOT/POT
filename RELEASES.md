...
* Fix reg\_div function compatibility with numpy in `ot.unbalanced.lbfgsb_unbalanced` via new function `ot.utils.fun_to_numpy` (PR #731)
...
* Fix bug where gromov\_wasserstein2 does not perform backpropagation with CUDA
...
* Documentation always up-to-date with README, RELEASES, CONTRIBUTING and
  CODE\_OF\_CONDUCT files (PR #316, PR #322).
...
corresponding to the last release and the master version <https://pythonot.github.io/master> that corresponds to the
...
<https://github.com/PythonOT/POT> and the
...
<https://PythonOT.github.io/> instead of
...
* New documentation on <https://PythonOT.github.io/> (PR #160, PR #143, PR #144)
...
* emd and emd2 can now return dual variables and have max\_iter (PR #29 and PR #25)
