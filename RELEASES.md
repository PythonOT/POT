...
This release is also the moment to thank all the POT contributors (old and new) for helping making POT such a nice to use toolbox. A lot of changes (also in the API) are comming for the next versions. 
