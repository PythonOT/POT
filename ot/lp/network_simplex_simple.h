...
* April 2018: IMPORTANT bug fix + uses 64bit integers (slightly slower but less
* risks of overflows), updated to a newer version of the algo by LEMON, sparse
* flow by default + minor edits.
*
*
