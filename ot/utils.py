...
## Implementation of the OTResultLazy class for ot.solve_sample() with potentials and lazy_plan as attributes 

class OTResultLazy:
    def __init__(self, potentials=None, lazy_plan=None, backend=None):
    ...
    @property
    def lazy_plan(self):
        """A subset of the Transport plan, encoded as a dense array."""
