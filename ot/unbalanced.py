...
def sinkhorn_unbalanced(a, b, M, reg, reg_m, method='sinkhorn',
    ...
    if method.lower() == 'sinkhorn':
        ...
        return sinkhorn_unbalanced_translation_invariant(a, b, M, reg, reg_m, reg_type,
                                                         warmstart, numItermax=numItermax,
                                                         stopThr=stopThr,
                                                         verbose=verbose,
                                                         log=log, **kwargs)
...
def sinkhorn_unbalanced2(a, b, M, reg, reg_m, method='sinkhorn',
    ...
    ot.unbalanced.sinkhorn_unbalanced_translation_invariant: :ref:`[70] <references-sinkhorn-unbalanced-translation-invariant>`
    """
    ...
    if len(b.shape) < 2:
        if method.lower() == 'sinkhorn':
            ...
            res = sinkhorn_unbalanced_translation_invariant(a, b, M, reg, reg_m, reg_type,
                                                            warmstart, numItermax=numItermax,
                                                            stopThr=stopThr, verbose=verbose,
                                                            log=log, **kwargs)
