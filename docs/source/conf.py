...
MOCK_MODULES = ["cupy", "tensorflow", "tensorflow.compat.v1", "jax", "jaxlib"]
...
latex_documents = [
    (master_doc, "POT.tex", "POT Python Optimal Transport library", author, "manual"),
]
...
man_pages = [(master_doc, "pot", "POT Python Optimal Transport", [author], 1)]
...
autodoc_default_options = {"autosummary": True, "autosummary_imported_members": True}
