...
.. minigallery:: ../../examples/gromov/plot_*.py
...
.. toctree::
    ...
    unbalanced-partial/plot_*

.. minigallery:: 
    ../../examples/unbalanced-partial/plot_*.py
    ...
    ../../examples/others/plot_outlier_detection_with_COOT_and_unbalanced_COOT.py
...
.. toctree::
    ...
    sliced-wasserstein/plot_*

.. minigallery:: 
    ../../examples/sliced-wasserstein/plot_*.py 
    ../../examples/plot_compute_emd.py
    ../../examples/unbalanced/plot_partial_1d.py
    ../../examples/unbalanced/plot_UOT_1D.py
    ../../examples/unbalanced/plot_UOT_sliced.py
...
.. minigallery:: ../../examples/lowrank/plot_*.py
...
.. toctree::
    ...
    domain-adaptation/plot_*

.. minigallery:: ../../examples/domain-adaptation/plot_*.py
...
.. minigallery:: ../../examples/others/plot_*.py
